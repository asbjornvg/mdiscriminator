#ifndef MDISCR_HOST_BASELINE
#define MDISCR_HOST_BASELINE

#include "MdiscrKernels_baseline.cu.h"
...
void mdiscr( const unsigned int       num_elems,
    ...
    // where k is the equivalence class that the element maps to.
    ...
    gpuErrchk( cudaMemcpy(&reduction, &scan_results[num_elems-1],
    ...
    gpuErrchk( cudaMemset(sizes_array, 0, num_elems * sizeof(int)) );
